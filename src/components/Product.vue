...
<template>
  <li 
    ...
    class="flex items-center space-x-6 border-gray-200 p-6 bg-white shadow"
  >
    <img :src="product.image" :alt="product.image" class="h-24 w-24" />
    ...
    <div class="space-y-2 flex-auto">
      ...
      <p class="font-extrabold">
        ...
        <span class="text-green-600 font-bold"> en existencia</span>
      </p>
    </div>
